...
public class Util {
     ...
     */
    private static final String SHARED_PREFS = "packagedelivery".toUpperCase(Locale.ENGLISH) + "_PREFS";
     ...
     */
    public static void generateNotification(Context context, String message, String url) {
        int icon = R.drawable.status_icon;
        long when = System.currentTimeMillis();

        Intent notificationIntent = new Intent(context, PackageDeliveryActivity.class);
        notificationIntent.putExtra("url", url);

        PendingIntent contentIntent = PendingIntent.getActivity(context, 0, notificationIntent, 0);

        Notification notification = new Notification(icon, message, when);
        notification.setLatestEventInfo(context, "Remote Package Signing", message, contentIntent);
    ...
    public static void generateNotification(Context context, String message) {
        ...
        Notification notification = new Notification(icon, message, when);
        notification.setLatestEventInfo(context, "Remote Package Signing", message,
