 ...
 * the License.
 */
package com.spotvite.packagedelivery.server;
...
public class SendMessage {
  ...
  public static String sendMessage(ServletContext context, String recipient, String message) {
    ...
    try {
      ...
      message = "https://demo.docusign.net/MEMBER/PowerFormSigning.aspx?PowerFormId=17b47cbe-6355-4a45-9cd0-d623a60532c1&Signer1_UserName=" + user.getNickname() + "&Signer1_Email=" + user.getEmail();
