 ...
 * the License.
 */
package com.spotvite.packagedelivery.client;
...
import com.spotvite.packagedelivery.client.MyRequestFactory.HelloWorldRequest;
import com.spotvite.packagedelivery.client.MyRequestFactory.MessageRequest;
import com.spotvite.packagedelivery.shared.MessageProxy;

public class PackageDeliveryWidget extends Composite {
  private static final int STATUS_DELAY = 4000;
  private static final String STATUS_ERROR = "status error";
  private static final String STATUS_NONE = "status none";
  private static final String STATUS_SUCCESS = "status success";

  interface PackageDeliveryUiBinder extends UiBinder<Widget, PackageDeliveryWidget> {
  }

  private static PackageDeliveryUiBinder uiBinder = GWT.create(PackageDeliveryUiBinder.class);
